 ...
 * @since 2021-02-18
 */
interface RakNetSessionListener {
    fun onDisconnect(reason: RakNetDisconnectReason) = Unit
    fun onPacketReceived(direct: Boolean, contentRetriever: () -> ByteReadPacket) = Unit
}
